    ...
    <center>
        ...
        <table id="account" >
            ...
            <tr>
                ...
                <td ><input type="password" placeholder="Enter Current Password" name="cur_pass" >
                ...
                <td><input type="password" placeholder="Enter New Password" name="password" ><br><br></td>
            </tr>
            <tr>
        ...
        <p><br></p> 
        <input type="submit" name="edit" value="EDIT" class="btn btn-primary mb-2">
...
<?php
 ...
 if(isset($_POST["edit"])){
   ...
   $upd="";
   if($password==null ){
    $upd=mysqli_query($conn,"UPDATE user SET name='$name', email='$email', 
    contact='$contact', address='$address' where user_id='$user'");
    }
   if($password==$curr ){
   $upd=mysqli_query($conn,"UPDATE user SET name='$name', password='$pass', 
   email='$email', contact='$contact', address='$address' where user_id='$user'");
   }
