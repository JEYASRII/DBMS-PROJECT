                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav m-auto font-rubik">
                    ...
                    <li class="nav-item">
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="signlog.html">Login to take quiz</a>
                      </li>
          ...
          <!-- Owl-carousel -->
            <section id="banner-area">
              <div class="owl-carousel owl-theme">
                  <div class="item">
                    <img src="../assets/ad/coffeescrub.jpg" alt="Banner1">
                  </div>
                  <div class="item">
                    <img src="../assets/ad/mamaearth.jpg" alt="Banner2">
                  </div>
                  <div class="item">
                    <img src="../assets/ad/plum.jpg" alt="Banner3">
                  </div>
                  <div class="item">
                    <img src="../assets/ad/vitc.jpg" alt="Banner4">
                  </div>
              </div>
            </section>
          <!-- !Owl-carousel -->
                ...
                <div class="owl-carousel owl-theme">
                  <div class="item py-2">
                    ...
                    <div class="product font-rale">
                      <a href="#"><img src="<?php  
                      $sql=mysqli_query($conn,"SELECT pro_image from prod where pro_id=13");
                  ...
                  <div class="item py-2">
                    ...
                    <div class="product font-rale">
                      <a href="#"><img src="<?php 
                      $sql=mysqli_query($conn,"SELECT pro_image from prod where pro_id=14");
                      $top=mysqli_fetch_assoc($sql);
                      echo $top["pro_image"];?>" alt="product1" class="img-fluid"></a>
                  ...
                  <div class="item py-2">
                    ...
                    <div class="product font-rale">
                      <a href="#"><img src="<?php  
                      $sql=mysqli_query($conn,"SELECT pro_image from prod where pro_id=15");
                      $top=mysqli_fetch_assoc($sql);
                      echo $top["pro_image"];?>" alt="product1" class="img-fluid"></a>
                  ...
                  <div class="item py-2">
                    ...
                    <div class="product font-rale">
                      <a href="#"><img src="<?php 
                      $sql=mysqli_query($conn,"SELECT pro_image from prod where pro_id=18");
                      $top=mysqli_fetch_assoc($sql);
                      echo $top["pro_image"];?>" alt="product1" class="img-fluid"></a>
                  ...
                  <div class="item py-2">
                    ...
                    <div class="product font-rale">
                      <a href="#"><img src="<?php 
                      $sql=mysqli_query($conn,"SELECT pro_image from prod where pro_id=29");
                      $top=mysqli_fetch_assoc($sql);
                      echo $top["pro_image"];?>" alt="product1" class="img-fluid"></a>
            ...
            <div class="col-lg-4 col-12"></div>
              ...
              <form class="form-row">
                  ...
                  <h4 class="font-rubik font-size-20">ACCOUNT</h4>
                    <p><a href="#" class="font-rale font-size-14 text-white-50 pb-1">MY ACCOUNT</a></p>
                    <p><a href="#" class="font-rale font-size-14 text-white-50 pb-1">MY ORDERS</a></p>
